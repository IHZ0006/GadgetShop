...
public class Mobile extends Gadget
{
    ...
    private void errorPrompt(int errorCode)
    {
        ...
        try //For the case when user enters not an integer value, we have a try-catch block
        {
            ...
            {
                case 0: remainingMinutesPrompt = Integer.parseInt(JOptionPane.showInputDialog(GadgetShop.frame, "Enter the value greater than 0")); break;
                case 1: remainingMinutesPrompt = Integer.parseInt(JOptionPane.showInputDialog(GadgetShop.frame, "Insufficient credit. Please, enter the desired number of minutes to top up")); break;
                case 2: remainingMinutesPrompt = Integer.parseInt(JOptionPane.showInputDialog(GadgetShop.frame, "Please, enter the correct value")); break;
            }
